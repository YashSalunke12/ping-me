      ...
      <div className="w-full max-w-md relative z-10 pt-20">
        <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-8">
          ...
          <button
            ...
            disabled={loading}
            className={`${loading && "opacity-50"} cursor-pointer w-full py-3 px-4 border border-white/20 rounded-xl hover:bg-white/10 transition flex items-center justify-center gap-3 mb-6`}
          >
